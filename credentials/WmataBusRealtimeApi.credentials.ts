...
export class WmataBusRealtimeApi implements ICredentialType {
	name = 'N8nDevWmataBusRealtimeApi';

	displayName = 'wmata-bus-realtime API';

	icon: Icon = { light: 'file:../nodes/WmataBusRealtime/wmata-bus-realtime.png', dark: 'file:../nodes/WmataBusRealtime/wmata-bus-realtime.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your wmata-bus-realtime API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
